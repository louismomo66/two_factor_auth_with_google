...
import { ColumnDirective, ColumnsDirective, GridComponent, Page, Inject, Search, Toolbar } from '@syncfusion/ej2-react-grids';
...
export class LabList extends React.Component {
  ...
  gridTemplate(props) {
    ...
    return (<div className='text-danger'>
      <ButtonComponent onClick={() => console.log('clicked:', id)} cssClass='e-info'>Request</ButtonComponent>
    </div>);
  }
      ...
      <div className='control-pane'>
        <div className='control-section'>
          <GridComponent dataSource={this.data} ref={g => this.grid = g} pageSettings={this.pageSettings}
            ...
            <ColumnsDirective>
              <ColumnDirective field='name' headerText="Lab Name" width='130' />
              <ColumnDirective field='code' headerText='Lab Code' width='50' />
              {/* <ColumnDirective field='startDate' headerText='Starts' width='70'  /> */}
              <ColumnDirective field='StopDate' headerText='Ends' width='70'  />
              <ColumnDirective headerText='Request Access' width='60' template={this.template}  />
            </ColumnsDirective>
